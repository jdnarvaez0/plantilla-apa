...
class AuthorDto {
  ...
  @ApiPropertyOptional({ description: 'Segundo nombre o inicial', example: 'David' })
  @IsOptional()
...
class CoverPageConfigDto {
  ...
  @IsEnum(CoverPageType, { message: 'Tipo de portada inválido. Opciones: student, professional' })
  type: CoverPageType;

  @ApiPropertyOptional({ description: 'Incluir número de página en portada', default: false })
  @IsOptional()
...
export class CreateDocumentDto {
  ...
  @IsEnum(DocumentType, { message: 'Tipo de documento inválido. Opciones: essay, research_paper, thesis, report' })
  type: DocumentType;

  @ApiProperty({ description: 'Título del trabajo', example: 'Software en Argentina' })
  ...
  @ApiProperty({ description: 'Institución educativa', example: 'Universidad de Buenos Aires' })
  ...
  @ApiPropertyOptional({ description: 'Nombre del curso o asignatura', example: 'Ingeniería de Software' })
  @IsOptional()
  @IsString({ message: 'El curso debe ser un texto' })
  @MaxLength(200, { message: 'El curso no puede exceder 200 caracteres' })
  course?: string;

  @ApiPropertyOptional({ description: 'Nombre del profesor', example: 'Dr. García' })
  @IsOptional()
  @IsString({ message: 'El profesor debe ser un texto' })
  @MaxLength(200, { message: 'El nombre del profesor no puede exceder 200 caracteres' })
  professor?: string;

  @ApiProperty({ description: 'Fecha de entrega', type: Date, example: '2026-02-14' })
  ...
  @ApiPropertyOptional({
    ...
    example: 'Este trabajo analiza el estado actual del software en Argentina...'
  })
  @IsOptional()
  @IsString({ message: 'El abstract debe ser un texto' })
  @MaxLength(3000, { message: 'El abstract no puede exceder 3000 caracteres (~250 palabras)' })
  abstract?: string;
  ...
  @ArrayMaxSize(10, { message: 'No se pueden agregar más de 10 palabras clave' })
