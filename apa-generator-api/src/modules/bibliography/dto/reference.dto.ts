...
class BaseReferenceDto {
  ...
  @IsEnum(ReferenceType, {
    message:
      'Tipo de referencia inválido. Opciones: book, journal_article, website, thesis',
  })
  type: ReferenceType;
...
export class WebsiteReferenceDto extends BaseReferenceDto {
  ...
  @MaxLength(200, {
    message: 'El nombre del sitio web no puede exceder 200 caracteres',
  })
  websiteName: string;

  @ApiProperty({
    description: 'URL del recurso',
    example: 'https://www.bbc.com/article',
  })
  @IsString({ message: 'La URL debe ser un texto' })
...
export class ThesisReferenceDto extends BaseReferenceDto {
  ...
  @IsEnum(
    { DOCTORAL: 'doctoral', MASTERS: 'masters' },
    {
  ...
  @ApiPropertyOptional({
    description: 'Base de datos donde se publicó',
    example: 'ProQuest',
  })
  @IsOptional()
